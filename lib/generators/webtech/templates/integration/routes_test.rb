...
class RoutesTest < ActionDispatch::IntegrationTest
  ...
  test 'should route to dishes index' do
    assert_routing 'restaurants/1/dishes', controller: 'dishes', action: 'index', restaurant_id: '1'
  end

  test 'should route to dishes show' do
    assert_routing 'restaurants/1/dishes/1', controller: 'dishes', action: 'show', restaurant_id: '1', id: '1'
  end

  test 'should route to items index' do
    assert_routing 'restaurants/1/dishes/1/items', controller: 'items', action: 'index', restaurant_id: '1',
                                                   dish_id: '1'
  end

  test 'should route to items show' do
    assert_routing 'restaurants/1/dishes/1/items/1', controller: 'items', action: 'show', restaurant_id: '1',
                                                     dish_id: '1', id: '1'
  end
end
